...
<html>
   ...
   <head>
    ...
    <title>Establishment | Token Booking</title>
   ...
   <body>
      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 class="title-font font-medium text-3xl text-white">APPROVING TOKEN</h1>
            <p class="leading-relaxed mt-4">This section is for shop owners.<br>
            Approve request and assign the token.</p>
          </div>
      ...
      <br><br>
      <form method="POST" action="approvetoken.php">
      <table width=100% border="all" style="background-color: gray; margin-top: 70px;text-align: center;" >
                <tr>
       ...
       <?php 
                    ...
                    $query="SELECT * FROM book WHERE status = 'pending' and sid = '$login_shopid'";
                    ...
                    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                        ...
                        echo   "<tr>
                                    <td>$i</td>
                                    <td>$name</td>
                                    <td style='padding:5px;'><input type='submit' class='text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg' name='approve' value=$i></td>
                                </tr>";
   ...
   <button class='text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg'><a href="shophome.php"> Back</a></button>
   </center>
      </div>
  </section>
