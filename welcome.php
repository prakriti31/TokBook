...
<html">
   ...
   <body>
      ...
      <center><h1 class="title-font font-medium text-3xl text-white">Sucessfully logged in as <?php echo $login_session; ?><br>(ADMIN)</h1></center>
      <br><br>
      ...
      <button class="text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg"><a href="verificationbyadmin.php"> Shops Verification</a></button>
  </center>
      </div>
  </section>
  <hr>
