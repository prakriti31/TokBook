...
session_start();
   ...
   $city=$_POST['city'];
  $_SESSION['city']=$city;
  $query="SELECT * FROM shoplocation WHERE city = '$city'";
  ...
  header("location: shopdisplay.php");
    ...
    header("location: noshop.php");
  }
}
if(isset($_POST['check']))
   {
   
    header("location: checktokens.php");
  }
?>
<html">
   ...
   <body>
      ...
      <center><h1 class="title-font font-medium text-3xl text-white">Welcome <?php echo $login_session;?><br>(CUSTOMER)</h1></center>
      <form method="post" action="welcomecustomer.php">
      <br><br>
      <br><br><br><br><br><br><br><br><center><h2 class="text-white text-lg font-medium title-font mb-5">Enter Your City</h2><br>
        <input class="bg-white-900 rounded border text-black border-black-900 focus:outline-none focus:border-teal-500 text-base px-4 py-2 mb-4" placeholder="Enter Your City" type="text" name="city"><br><br><br>
      ...
      <br><br><br><br><br><br><center><h2 class="text-white text-lg font-medium title-font mb-5">Check your token</h2><br>
      <button class="text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg" id="check" name="check">CHECK </button>
