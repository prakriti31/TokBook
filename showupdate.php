      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 class="title-font font-medium text-3xl text-white">Token</h1>
            <p class="leading-relaxed mt-4">This section is for customer.<br>
          </div>
      <center><h1 class="title-font font-medium text-3xl text-white">Welcome <?php echo $login_session;?><br>(CUSTOMER)<br><br><br></h1></center>
       <?php 
                   $sid=$_SESSION['upshop'];
                      $query = mysqli_query($con,"SELECT tokenno FROM updatetoken WHERE sid = '$sid'");
                      $row = mysqli_fetch_array($query, MYSQLI_ASSOC);
                      $tokenno = $row['tokenno'];
                      echo "<br><h1 class='title-font font-medium text-3xl text-white'>Current Token: $tokenno<br></h1>";
                 
                ?>
          </table></form>
</p></div></div><br><br><br><br><br><br></section>
  <hr>
