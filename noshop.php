...
<html>
   ...
   <body>
      ...
      <center><h1 class="title-font font-medium text-3xl text-white">Sorry <?php echo $login_session;?><br>(CUSTOMER)<br> But no shop is <br> registered on this portal from<br> the city you have entered. </h1>
      </center>
      <button class='text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg'><a href="welcomecustomer.php"> Back</a></button>
      </div>
      <br><br><br><br>
  </section>
