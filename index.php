    ...
    <header class="text-gray-500 bg-gray-900 body-font">
      ...
      <section class="text-gray-500 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <img style="height: 60%;width: 85%;" class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="img/homepage.jpg">
          <div class="text-center lg:w-2/3 w-full">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">ToKBooK</h1>
            <p class="leading-relaxed mb-8">People are continually going to go shopping. A considerable measure of our exertion is simply: ‘How would we make the retail encounter an incredible one?’</p>
